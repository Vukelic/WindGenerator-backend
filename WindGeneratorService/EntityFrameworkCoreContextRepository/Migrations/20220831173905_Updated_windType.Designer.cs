...
namespace EntityFrameworkCoreContextRepository.Migrations
{
    ...
    [Migration("20220831173905_Updated_windType")]
    partial class Updated_windType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepositoryModel.RepoModels.Implementations.WindGeneratorDevice.RepoWindGeneratorDevice", b =>
                {
                    ...
                    b.Property<long>("ParentWindGeneratorTypeId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ParentWindGeneratorTypeId");
            ...
            modelBuilder.Entity("RepositoryModel.RepoModels.Implementations.WindGeneratorType.RepoWindGeneratorType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("GeneratorPower")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Guarantee")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HeightOfWing")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ImageUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("InstallationCosts")
                        .HasColumnType("int");

                    b.Property<bool>("IsVirtual")
                        .HasColumnType("bit");

                    b.Property<string>("MaxPowerTurbine")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MaxSpeedTurbine")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PowerOfTurbines")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Turbines")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Weight")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("WidthOfWing")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("WindGeneratorTypes");
                });
            ...
            modelBuilder.Entity("RepositoryModel.RepoModels.Implementations.WindGeneratorDevice.RepoWindGeneratorDevice", b =>
                {
                    b.HasOne("RepositoryModel.RepoModels.Implementations.User.RepoUser", "ParentUser")
                        .WithMany("ListOfWindGeneratorDevice")
                        .HasForeignKey("ParentUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RepositoryModel.RepoModels.Implementations.WindGeneratorType.RepoWindGeneratorType", "ParentWindGeneratorType")
                        .WithMany("ListOfGenerators")
                        .HasForeignKey("ParentWindGeneratorTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ParentUser");

                    b.Navigation("ParentWindGeneratorType");
                });
            ...
            modelBuilder.Entity("RepositoryModel.RepoModels.Implementations.User.RepoUser", b =>
                {
                    b.Navigation("ListOfWindGeneratorDevice");
                });
