...
namespace RepositoryModel.RepoModels.Implementations.WindGeneratorType
{
    public class RepoWindGeneratorType : ARepoBaseEntity
    {
        ...
        private List<RepoWindGeneratorDevice> _ListOfGenerators;
        public virtual List<RepoWindGeneratorDevice> ListOfGenerators
        {
